...
- **Migrations run at start-up in the Fastify process**, before it listens ([ADR-0015](0015-schema-migration-strategy.md)). The production guard refuses to listen rather than refusing to build.
