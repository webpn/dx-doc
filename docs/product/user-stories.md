...
[REQ-DOM-017](requirements/REQ-DOM.md), [REQ-DOM-018](requirements/REQ-DOM.md) → [REQ-DOM-020](requirements/REQ-DOM.md)
...
> **This capability does not exist in R1 in any form.** The prose stopgap was rejected rather than shipped ([REQ-DOM-011](requirements/REQ-DOM.md)), which is why there is no conversion exercise across the imported products and why this story appears once, here, rather than spanning two releases. Two later stories depend on it and on nothing else: [US-DEV-04](#us-dev-04--see-only-the-values-that-apply-to-my-scenario--developer--e4) and mechanical conformance checking in R4.
