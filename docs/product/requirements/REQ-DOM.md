...
- The current *Page View* and *Action* templates are expressible as instances of this mechanism, with no hard-coded behaviour remaining.
...
Preferring generic properties qualified by context, and explicit names over generic ones such as *category* or *type*, remains a human review responsibility and is **not** automated.
