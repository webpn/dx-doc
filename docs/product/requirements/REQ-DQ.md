...
**Blocked by:** open decision O1 — ontology classes, IRI scheme, export formats, and the actual consumer in the data warehouse. Scope is undefined until O1 closes at [M5.0](../milestones.md), which must happen **before the end of R2**.
...
**Blocked by:** open decision O2 — how technical name and business label relate, and what else the glossary needs.
