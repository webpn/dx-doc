...
- **Admin** — creates and configures projects *within their company*, configures its integrations, manages its catalogue, reads its audit log, archives and restores its projects. **Creating companies is not an Admin action** — see below.
